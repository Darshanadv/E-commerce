        ...
        <nav className="hidden md:block ">
          <ul className="grid grid-flow-col gap-5">
            <li>
              <a
                href="/src/index.html"
                className="block py-navbar-item px-navbar-item hover:bg-slate-900 text-1xl"
                onClick={(e) => {
                  e.preventDefault();
                  navigate("/landing");
                }}
          ...
          <ul className="grid grid-flow-col items-center gap-10">
            <li>
              <a
                ...
                className="inline-flex items-center py-navbar-item px-navbar-item hover:bg-slate-900 text-1xl"
              >
                <svg
            ...
            <li className="relative">
              <a
                ...
                className="flex items-center py-navbar-item px-navbar-item pr-5 hover:bg-slate-900 text-1xl"
              >
              ...
              {myAccount && (
                <ul className="absolute z-10 right-0 bg-slate-800 py-2 w-48">
                  ...
                  <li>
                    <a
                      href="/watchlist"
                      className="flex items-center px-3 py-2 hover:bg-slate-900 text-1xl"
                      onClick={(e) => {
                        e.preventDefault();
                        navigate("/watchlist");
                      }}
